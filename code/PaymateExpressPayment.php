...
class PaymateExpressPayment extends Payment
{
    ...
    public static function SetPaymateUrl($id)
    {
        self::$paymate_url = $id;
    }

    public static function GetPaymateUrl()
    {
    ...
    public function PaymateForm($data)
    {
...
HTML;
    ...
    public function getPaymentFormRequiredFields()
    {
        return array();
    }
}
